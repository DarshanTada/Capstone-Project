...
class CategoryScreenState extends State<CategoryScreen> {
  ...
  screenBody() {
    final getProductsByCategory = Provider.of<CategoryProvider>(
      context,
    ).categoryProducts;

    // Show loader if data is loading or if products data is not available
    if (isLoading || getProductsByCategory.isEmpty) {
      return SizedBox(
        height: dH,
        width: dW,
        child: Center(
          child: SizedBox(
            ...
            child: CircularProgressIndicator(
              strokeWidth: 3,
              valueColor: AlwaysStoppedAnimation<Color>(Color(0xFF76929F)),
            ),
          ),
        ),
      );
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          if (getProductsByCategory.length > 1 &&
                              getProductsByCategory[1]['products'] != null &&
                              getProductsByCategory[1]['products'].length > 0)
                            CustomSmallProductCardGrid(
                              imageBytes: decodeBase64Image(
                                getProductsByCategory[1]['products'][0]['images'][0]['image']['base64'],
                              ),
                              price: '50',
                              rating: 3.9,
                              onTap: () {},
                          ...
                          if (getProductsByCategory.length > 1 &&
                              getProductsByCategory[1]['products'] != null &&
                              getProductsByCategory[1]['products'].length > 2)
                            CustomSmallProductCardGrid(
                              imageBytes: decodeBase64Image(
                                getProductsByCategory[1]['products'][2]['images'][0]['image']['base64'],
                              ),
                              price: '44',
                              rating: 4.7,
                              onTap: () {},
